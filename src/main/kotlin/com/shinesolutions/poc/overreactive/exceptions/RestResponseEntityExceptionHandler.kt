...
class RestResponseEntityExceptionHandler {
    ...
    fun handleNotFoundException(ex: RuntimeException, request: WebRequest): ResponseEntity<Error> {
        ...
        val code = "POC-404"
        return handleExceptionInternal(ex, code, body, HttpStatus.NOT_FOUND)
    }

    private fun handleExceptionInternal(ex: RuntimeException, code: String, body: String, status: HttpStatus): ResponseEntity<Error> {
